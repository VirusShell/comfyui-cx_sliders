    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        nodeType.prototype.onConfigure = function(info) {
            if (info.properties) {
                ...
                this.dialProps.fillColor = isValidHexColor(info.properties.fillColor) ? info.properties.fillColor : "#d99a4a";
        ...
        nodeType.prototype.onDblClick = function(e, pos, canvas) {
            if (this._isInDialBounds(pos[0], pos[1])) {
                canvas.prompt("Value", this._formatValue(this.dialProps.current), (v) => {
                    if (!isNaN(Number(v))) {
