    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        nodeType.prototype.onConfigure = function(info) {
            if (info.properties) {
                ...
                this.rangeProps.step = Math.max(1, Math.round(info.properties.step ?? 1));
                this.rangeProps.snap = info.properties.snap ?? true;
                this.rangeProps.fillColor = isValidHexColor(info.properties.fillColor) ? info.properties.fillColor : "#4a90d9";
        ...
        nodeType.prototype.onDblClick = function(e, pos, canvas) {
            if (this._isInSliderBounds(e)) {
                ...
                canvas.prompt(handle === "low" ? "Low Value" : "High Value", currentVal, (v) => {
                    if (!isNaN(Number(v))) {
