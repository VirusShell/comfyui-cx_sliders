...
A bank of 1-8 integer sliders in a single compact node, with add/remove buttons to control the number of active sliders.

## Inputs

| Name | Type | Default | Description |
|------|------|---------|-------------|
| values | STRING | `{"s1":0,"s2":0,...,"s8":0}` | JSON object containing slider values (keys: s1-s8) |

## Outputs

| Name | Type | Description |
|------|------|-------------|
| out_1 through out_8 | INT | Individual integer outputs for each active slider |
...
| min | int | 0 | Minimum value for all sliders |
| max | int | 100 | Maximum value for all sliders |
